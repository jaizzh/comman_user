  ...
  return Container(
    child: Row(
      ...
      children: [
          ...
          choosecreate(onTapper: (){}, pather: 'assets/images/chat2.png', name: 'View Invites'),
          choosecreate(onTapper: (){}, pather: 'assets/images/chat3.png', name: 'Gift Shop'),
      ],
    ),
  );
}
  ...
  return GestureDetector(
    ...
    child: Column(
      children: [
        ...
        SizedBox(height:2.0,),
        Text(name,style: TextStyle(fontSize:13.0,fontWeight: FontWeight.bold,color:Colors.black),),
      ],
    ),
  );
}Widget venues() {
 ...
 Widget allvendors(){
  return Padding(
    ...
    child: Container(
      ...
      child: Center(
        child: Text("All Vendors",style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.bold,color: Colors.black),),
      ),),);}}