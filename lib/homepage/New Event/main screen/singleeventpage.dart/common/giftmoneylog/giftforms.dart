...
class _GiftLogFormsState extends State<GiftLogForms> {
  ...
  void _finishAndReturn() {
    ...
    print(
        '🟣 _finishAndReturn called with ${giftvalueforms.length} items'); // Debug
        ...
        leading: Container(
          ...
          child: IconButton(
            icon: Icon(Icons.arrow_back_ios_new_rounded,
                color: AppColors.buttoncolor, size: size.width * 0.05),
            onPressed: () => Navigator.maybePop(context),
          ),
        ),
        title: Text("Gift Log Forms",
            style: TextStyle(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Form fields
                _buildFormField("Name", form1, Icons.person_2, size,
                    validator: (v) =>
                        (v == null || v.trim().isEmpty) ? "Required" : null),
                SizedBox(height: size.height * 0.02),
                _buildFormField(
                    "Mobile Number", form2, Icons.mobile_friendly_rounded, size,
                    keyboardType: TextInputType.phone,
                    validator: (v) =>
                        (v == null || v.trim().isEmpty) ? "Required" : null),
                SizedBox(height: size.height * 0.02),
                _buildFormField(
                    "Address", form3, Icons.local_activity_rounded, size,
                    maxLines: 2),
                SizedBox(height: size.height * 0.02),
                _buildFormField(
                    "Gift Name", form4, Icons.card_giftcard_rounded, size,
                    validator: (v) =>
                        (v == null || v.trim().isEmpty) ? "Required" : null),
                ...
                Row(
                  ...
                  children: [
                    // Add Another button
                    _secondaryBtn(size,
                        label: "Add Another", onTap: _addAnotherEntry),

                    // Continue button
                    _primaryBtn(size,
                        label: "Continue", onTap: _finishAndReturn),
                  ],
                ),
                SizedBox(height: size.height * 0.02),
              ],
      ...
      child: Container(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            prefixIcon:
                Icon(icon, color: Colors.black54, size: size.width * 0.05),
  ...
  Widget _secondaryBtn(Size size,
      {required String label, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
