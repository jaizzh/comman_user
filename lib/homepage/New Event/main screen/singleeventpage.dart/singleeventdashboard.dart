      ...
      Container(
        ...
        child: Column(
          children: [
            ...
            Row(
                children: [
                  venuevendor(pathds: "assets/images/venueor.png", namevenue: "Venue", uptohow: "upto 100+ Venues", stars: '⭐⭐⭐⭐⭐'),
                   venuevendor(pathds: "assets/images/vendoror.png", namevenue: "Vendors", uptohow: "upto 500+ Vendors", stars: '⭐⭐⭐⭐')
                ],
            ),
            SizedBox(height: 16.0,),
...
Widget planning(){
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Text("Planning Tools",style: TextStyle(fontSize: 14.0,fontWeight: FontWeight.bold,color: AppColors.buttoncolor )),
              SizedBox(width: 4.0,),
  ...
  Widget venuevendor({required String pathds,required String stars, required String namevenue,required String uptohow}){
    return Padding(
