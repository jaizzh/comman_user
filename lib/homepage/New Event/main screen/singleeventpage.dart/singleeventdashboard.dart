...
class _singleventdashboardState extends State<singleventdashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      actions: [
         IconButton(onPressed: (){}, icon: Icon(Icons.card_giftcard_rounded,color: Colors.black,size: 18.0,)),
        IconButton(onPressed: (){}, icon: Icon(Icons.edit,color: Colors.black,size: 18.0,))
      ],
    ),
...
Widget commontools(){
  return SizedBox(
    child:SingleChildScrollView(
      ...
      child: Row(
      children: [
        commmontoolcontainer(toolname: "Gift Registry", toolvalue: 0.2, colodf: Colors.amberAccent.shade400, Subtoolname: 'Add Some Gift Registry', valuesstring: '1/5'),
         commmontoolcontainer(toolname: "Invitation", toolvalue: 0.4, colodf: Colors.cyanAccent, Subtoolname: 'Make invitation for your event', valuesstring: '1/4'),
          commmontoolcontainer(toolname: "Video Invitation", toolvalue: 0.1, colodf: Colors.greenAccent, Subtoolname: 'Video invitation for your gustes', valuesstring: '1/10'),
           commmontoolcontainer(toolname: "Money Gifts Report", toolvalue: 0.542, colodf: Colors.tealAccent, Subtoolname: 'Receive your money gift', valuesstring: '4/6'),
            commmontoolcontainer(toolname: "Co-Hosts", toolvalue: 0.651, colodf: Colors.amberAccent.shade100, Subtoolname: 'Collab with your friends & family', valuesstring: '2/3'),
      ],
    ),
    ) 
  );
...
Widget planning(){
  return Padding(
    ...
    child: GestureDetector(
      onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (_)=>  planningtools() ));
      },
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
        ...
        child: Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text("Planning Tools",style: TextStyle(fontSize: 12.0,fontWeight: FontWeight.bold,color: AppColors.buttoncolor )),
              SizedBox(width: 4.0,),
              Icon(Icons.construction,color: AppColors.buttoncolor,size: 16.0,),
            ],
          ),
        ),
      ),
          ...
          Container(
            ...
            child: Center(
              ...
              child:Column(
                ...
                child: Icon(icon, color: Colors.white, size: squareSize * 0.30),
              ),
          const SizedBox(height: 4),
          Text(
                textAlign: TextAlign.center,
                maxLines: 2,
                title,style: TextStyle(fontSize:10,fontWeight: FontWeight.bold,color:Colors.black,height: 1.0),),
                ],
              ),
