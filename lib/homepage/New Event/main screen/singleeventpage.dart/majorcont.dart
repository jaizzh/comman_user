    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppColors.boxlightcolor.withOpacity(0.6),width: 2.0),
        ),
        child:Column(
          children: [
            Row(
            ...
            Row(
              children: [
               Row(
          children: [
              SizedBox(width: MediaQuery.of(context).size.width *0.25, child: Text("No Of Gusets Invited",textAlign: TextAlign.center, maxLines: 2,style: TextStyle(fontSize: 12.0,color: Colors.black,fontWeight: FontWeight.bold),)),
              SizedBox(width: 10.0,),
                _primaryBtn(
              label: 'Invite People',
  ...
  Widget about(){
      ...
      child: Column(
        ...
        children: [
         ...
         const SizedBox(height: 2),
               ...
               Row(
                children: [
                  Icon(Icons.people,size: 16.0,color: AppColors.buttoncolor,),SizedBox(width: 4.0,),
                   Text("Co-Hosts = 0",style: TextStyle(fontSize: 13.0,color: Colors.black,fontWeight: FontWeight.w700),),
                ],
               ),
                       ],
      ),
   ...
   width: MediaQuery.of(context).size.width * 0.280,
      child: ElevatedButton.icon(
        ...
        label: Text(label, style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 11.0)),
      ),
    );
  }
