    ...
    return Container(
      ...
      child: SleekCircularSlider(
        ...
        innerWidget: (_) => Column(
          ...
          children: [
            Text(" 234 / 500",style: TextStyle(fontSize: 15.0,fontWeight: FontWeight.w900,color: AppColors.buttoncolor),),
            // Text(money.format(value.round()), style: const TextStyle(fontSize: 20,fontWeight: FontWeight.w800)),
            const Text('Invite People', style: TextStyle(color: Colors.black,fontSize: 11.0)),
          ],
        ),
