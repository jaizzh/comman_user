...
class _eventplanState extends State<eventplan> {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            subform1(
                hint: " ${selectedType} Organizer Name",
                maxer: 30,
                specifyname: false,
                parteventname: subform1con),
            SizedBox(
              height: 6.0,
            ),
            label("Email Id"),
              ...
              .map(
                (eventtypename) => DropdownMenuItem<String>(
                  ...
                  child: Text(
                    eventtypename,
                    style: TextStyle(
                      color: eventtypename == "Select one"
                          ? Colors.black38
                          : Colors.black87,
                      fontWeight: FontWeight.w600,
                    ),
  ...
  Widget choosePlanButton({VoidCallback? onPressed}) {
    final bool isEnabled = selectedType != "Select one" &&
        startDate != null &&
        endDate != null &&
        !isInvalidDateRange; // && mobilename.length == 10 && eventName2.length >= 3  && subform11.length >= 3  && subform22.length >= 3  && subform33.length >= 3;
