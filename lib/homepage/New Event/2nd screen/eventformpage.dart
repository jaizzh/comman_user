                          ...
                          onPressed: () {
                            ...
                            WidgetsBinding.instance.addPostFrameCallback((_) {
                              RazorpayService.instance.openCheckout(
                                keyId:
                                    "rzp_test_1DP5mmOlF5G5ag", // "rzp_test_qnICfDxMOIbOaI",
                                amountPaise: 1000,
                                context: context, // ₹1,299 = 129900 paise
          ...
          Row(
            ...
            children: [
              const Icon(Icons.timelapse_rounded,
                  size: 13, color: Color(0xFF9A2143)),
              const SizedBox(width: 4),
              Text(
                daysText,
                style: GoogleFonts.inter(
          ...
          Row(
            ...
            children: [
              Icon(Icons.celebration_rounded,
                  size: 13, color: AppColors.buttoncolor),
              const SizedBox(width: 4),
              Text(
                eventType,
                style: GoogleFonts.inter(
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
              color: AppColors.boxdarkcolor.withOpacity(.6), width: 1),
          boxShadow: [
            BoxShadow(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: AppColors.boxdarkcolor.withOpacity(.6), width: 2),
                ),
