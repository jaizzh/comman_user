...
class _eventformpageState extends State<eventformpage> {
          ...
          ClipRRect(
            ...
            child: SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  // Background image
                  Image.asset("assets/images/trhg.png", fit: BoxFit.fill),
                ],
              ),
            ),
          ),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          widget.eventname1,
                          overflow: widget.eventname1.length >= 20
                    ...
                    Row(
                      ...
                      children: [
                        Icon(
                          ...
                          size: 24,
                          color: AppColors
                              .buttoncolor, // Use your gold/premium color
                        ),
                        const SizedBox(width: 6),
                        Text(
                          ...
                          style: GoogleFonts.inter(
                            ...
                            fontWeight: FontWeight.w700,
                            color:
                                AppColors.buttoncolor, // masked by ShaderMask
                            shadows: [
                              Shadow(
                                blurRadius: 8,
                                offset: Offset(0, 2),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/pnges.png"),
              ),
            ),
          ),
        ),
  ...
  Widget _metaPill({required String daysText, required String eventType}) {
    return Container(
