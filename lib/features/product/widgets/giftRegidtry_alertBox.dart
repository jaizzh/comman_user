...
import 'package:common_user/features/product/pages/choose_giftregistry_event_page.dart';
import 'package:common_user/features/vendor/widgets/navigation.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

void showGiftRegistryDialog(
  String productName,
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              "Do you want to add '$productName' to your gift registry?",
        ...
        actions: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              ...
              navigateWithSlide(
                  context, ChooseGiftregistryEventPage(product: product));
            },
            icon: const Icon(
              Icons.event,
              size: 18,
